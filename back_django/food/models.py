...
class Diet(models.Model):
    # 자동 생성 id를 pk로 사용
    uuid = models.ForeignKey(to=Users, on_delete=models.CASCADE)
    diet_date = models.DateTimeField(auto_now_add=True)
    meal = models.CharField(max_length=30)
    fid = models.ForeignKey(to=Food, on_delete=models.PROTECT)
    fname = models.CharField(max_length=30)
